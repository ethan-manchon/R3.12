/*
   ...
   . Corollaire : comprendre la notion de fonction "callback" (déclarée par le programmeur mais appelée par le navigateur)
...
let handler_betaspan = function(){
    let h1 = document.querySelector('h1'); // sélection de l'élément h1 du document
    h1.className = "beta"; // affectation de la classe de style "beta" à l'élément h1
};
...
let handler_gammaspan = function(){
    let h1 = document.querySelector('h1'); // sélection de l'élément h1 du document
    h1.className = "gamma"; // affectation de la classe de style "gamma" à l'élément h1
};
...
let handler_nonespan = function(){
   let h1 = document.querySelector('h1'); // sélection de l'élément h1 du document
   h1.className = "none"; // affectation de la classe de style "none" à l'élément h1
};
