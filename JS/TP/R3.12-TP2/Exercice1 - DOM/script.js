...
let tmp = columns[3].innerHTML;
columns[3].innerHTML = columns[1].innerHTML;
columns[1].innerHTML = tmp;
...
text.textContent = "It was this, as much as anything, that gave people courage, and I suppose the new arrivals from Woking also\
...
document.querySelector("figure").appendChild(text);
...
img.className = "media";
img.src = "http://i.giphy.com/4fDWVPMoSyhgc.gif";
img.alt = "Luke Skywalker";

let caption = document.createElement("figcaption");
caption.className = "figcaption";
caption.textContent = "This time, let go your conscious self and act on instinct.";


document.querySelectorAll('.collumn')[2].querySelector("p:nth-child(2)").appendChild(fig);
